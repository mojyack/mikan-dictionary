...
CONNECTION_DEFLATE_PATH = os.path.join(ROOT_DIR, 'mozc/src/data/dictionary_oss/connection.deflate')
MATRIX_DEF_PATH = os.path.join(ROOT_DIR, 'source/system/matrix.def')
